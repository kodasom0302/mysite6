					...
					<div id="list">
						<form action="${pageContext.request.contextPath}/tboard/list3" method="get">
							<div class="form-group text-right">
								<input type="text" name="keyword" values="">
								...
								<c:forEach begin="${pMap.startPageBtnNo}" end="${pMap.endPageBtnNo}" step="1" var="page">
									<c:choose>
										<c:when test="${param.crtPage==page}">
											<li calss="active"><a href="${pageContext.request.contextPath}/tboard/list3?crtPage=${page}&keyword=${param.keyword}">${page}</a></li>
										</c:when>
										<c:otherwise>
